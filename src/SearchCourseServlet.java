...
//		        }  		 
		...
		{
			out.println(
					"<html><script> alert(\"Please Enter Something!!!\"); window.location.href=\"courses.jsp\"</script></html>");
		}
		...
		try {
			...
			if (!found) {
				out.println(
						"<html><script> alert(\"Invalid Course ID!!!\"); window.location.href=\"courses.jsp\"</script></html>");
			}
		}
